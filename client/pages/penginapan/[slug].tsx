    ...
    <>
      ...
      <section className="container mx-auto px-10 mb-16">
        <div className="grid grid-cols-2 gap-x-16">
          ...
          <div>
            <h3 className="text-h3 font-medium text-black mb-3">Hotel Amburadul</h3>
            <p className="text-body text-purple-light mb-3 font-bold">Harga mulai:</p>
            <h4 className="text-h4 text-black font-medium mb-1">Rp 80.000/Malam</h4>
            ...
            <p className="text-body text-purple-light mb-5 font-bold">Fasilitas :</p>
